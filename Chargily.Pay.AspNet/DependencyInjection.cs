...
public class WebhookEndpointContext
{
...
public static class DependencyInjection
{
  ...
  public static RouteHandlerBuilder MapChargilyPayWebhookEndpoint(this WebApplication app, string endpointPath, Func<WebhookEndpointContext,Task> onWebhookReceived)
  {
